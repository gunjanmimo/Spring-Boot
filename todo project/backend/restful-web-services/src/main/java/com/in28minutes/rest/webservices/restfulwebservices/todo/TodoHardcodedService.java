...
public class TodoHardcodedService {
	...
	static {
		...
		todos.add(new Todo(++idCounter, "in28minutes","Learn to talk in german", new Date(), false ));
		todos.add(new Todo(++idCounter, "in28minutes","Learn about docker", new Date(), false ));
		todos.add(new Todo(++idCounter, "in28minutes","Learn about kubernate", new Date(), false ));
	}
